...
const makeConfig = function (defaultConfig, options) {
    ...
    const resolveMainFields = (options.name === 'main') ? ['main', 'module', 'browser'] : ['browser', 'module', 'main'];
    ...
    const config = merge.smart(defaultConfig, {
        ...
        resolve: {
            ...
            alias: {
                ...
                // Force using VM source instead of missing dist build
                'openblock-vm$': path.resolve(__dirname, 'node_modules', 'openblock-vm', 'src', 'index.js'),
                'openblock-vm/dist/node/openblock-vm.js$': path.resolve(__dirname, 'node_modules', 'openblock-vm', 'src', 'index.js'),
                'openblock-vm/dist/web/extension-worker.js$': path.resolve(__dirname, 'node_modules', 'openblock-vm', 'src', 'extension-support', 'extension-worker.js'),
                // Deduplicate React to avoid invalid hook call from multiple React copies
