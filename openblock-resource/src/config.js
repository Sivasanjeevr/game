...
/**
 * Disable external resource downloads for local development
 * @readonly
 */
const EXTERNAL_RESOURCES_DISABLED = true;

/**
 * External resources repository (disabled for local development)
 * @readonly
 */
const EXTERNAL_RESOURCES_REPO = null; // Disabled to prevent external downloads
...
module.exports = {
    ...
    REOPEN_INTERVAL,
    RECHECK_INTERVAL,
    EXTERNAL_RESOURCES_DISABLED,
    EXTERNAL_RESOURCES_REPO
};
